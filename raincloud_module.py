# -*- coding: utf-8 -*-
"""
Created on Fri Sep 15 11:22:07 2023
...
class _Half_ViolinPlotter(_CategoricalPlotter):
    ...
    def __init__(self, x, y, hue, data, order, hue_order,
                 ...
                 color, palette, saturation, offset, hatchs):
...
def half_violinplot(x=None, y=None, hue=None, data=None, order=None, hue_order=None,
               ...
               width=.8, inner="box", split=True, dodge=True, orient=None,
               linewidth=None, color=None, palette=None, saturation=.75,
               ax=None, offset=.15, hatchs=None, **kwargs):
...
def RainCloud(x = None, y = None, hue = None, data = None,
              ...
              alpha = None, dodge = False, linecolor = 'red', hatchs=None,
              draw_box=True, boxcolor='k', **kwargs):
    ...
    half_violinplot(x = x, y = y, hue = hue, data = data,
                    ...
                    cut = cut, scale = scale, split = split, offset = offset, ax = ax, hatchs=hatchs, **kwcloud)
